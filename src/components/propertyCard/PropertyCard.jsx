    ...
    return (
        <div key={property._id} className={classes.property}>
            <Link to={`/propertyDetail/${property._id}`} className={classes.imgContainer}>
                <img src={`https://realestate-backend-ru8e.onrender.com/images/${property?.img}`} alt="" />
            </Link>
            <div className={classes.details}>
                <div className={classes.priceAndOwner}>
                    <span className={classes.price}>Rs. {property.price}</span>
                    <img src={ownerProfileImg ? `https://realestate-backend-ru8e.onrender.com/images/${ownerProfileImg}` : person} className={classes.owner} />
                </div>
